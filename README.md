...
An AI-powered job search assistant built with **Tambo AI** that helps you analyze job descriptions, generate tailored content, and track applications through an interactive chat interface.

## ✨ Features

- 📋 **JD Analysis** - Extract details, calculate fit scores, identify skill gaps
- ✍️ **Content Generation** - Create resume bullets, cover letters, and talking points
- 📊 **Application Tracking** - Manage your pipeline with a kanban board (Interested → Applied → Interviewing → Offer/Rejected)
- 🤖 **Dynamic UI** - Tambo AI renders React components (cards, panels, boards) during conversation
...
```bash
npm install
# Rename example.env.local to .env.local and add your Tambo API key
npm run dev  # Start Next.js dev server on port 3000
```

Navigate to `http://localhost:3000/chat` to start chatting!

## 📖 Full Documentation

See **[JOB_COPILOT_GUIDE.md](./JOB_COPILOT_GUIDE.md)** for:
